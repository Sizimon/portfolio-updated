...
const Hero = () => {
    return (
        <section
            id='me'
            className="relative flex justify-center p-0 w-full h-lvh z-0"
        >
            <div className="relative flex flex-col z-50 h-full w-5/6 md:w-4/6  justify-center items-center">
                <h1 className='font-alt font-extralight uppercase text-uwq md:text-5xl uwq:!text-7xl text-center text-pop'>Szymon Samus</h1>
