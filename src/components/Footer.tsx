  ...
  return (
    <footer className="w-full mt-12 py-6 bg-background border-t border-border flex flex-col items-center text-center text-xs text-muted-foreground">
      <div className="flex flex-row gap-4 mb-2">
        <a href="https://github.com/Sizimon" target="_blank" rel="noopener noreferrer" className="UWQ:text-2xl hover:text-pop transition-colors">GitHub</a>
        <a href="mailto:szymonsamus@gmail.com" className="UWQ:text-2xl hover:text-pop transition-colors">Email</a>
